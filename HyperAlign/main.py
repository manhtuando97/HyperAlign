...
if __name__ == '__main__':
        ...
        parser.add_argument('--config', type=int, default=1, help='0: full-fledged, 1: Hyper-S, 2: Hyper-WC, 3: Hyper-WA, 4: Hyper-WAC')
        ...
        parser.add_argument('--walk_length', type=int, default=100, help='Length of walk per source. Default is 80.')
        parser.add_argument('--num_walks', type=int, default=100, help='Number of walks per source. Default is 10.')
        parser.add_argument('--window_size', type=int, default=50, help='Context size for optimization. Default is 10.')
        ...
        parser.add_argument('--lr_wd', type=float, default=0.001)
        parser.add_argument('--lr_recon', type=float, default=0.01)
        parser.add_argument('--alpha', type=float, default=0.1)
        parser.add_argument('--episode', type=int, default=10)
        parser.add_argument('--epd', type=int, default=1000)
        parser.add_argument('--t', type=int, default=3)

        # for final step
        parser.add_argument('--pred_output', nargs='?', default='prediction', help='Directory storing alignment prediction')
        parser.add_argument('--pred', type=int, default=1, help='1: save alignment prediction in prediction output direction, 0: not save')
        ...
        # HyperCL module
        num_nodes1, num_edges1, features1, hyperedge_index1, node_list1, node_list1_ = load_data(args.input, args.feat_output, args.dataset1)
        num_nodes2, num_edges2, features2, hyperedge_index2, node_list2, node_list2_ = load_data(args.input, args.feat_output, args.dataset2)
