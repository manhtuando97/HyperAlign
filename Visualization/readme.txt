...
1. Experimental results when the disparity scale between the two input hypergraphs are varied.
(in response to W3 by Reviewer NPqf and W2 Reviewer 6tyM)
...
Comparing performance of HyperAlign with self-loop, HyperAlign-self, and HyperAlign in the datasets after self-loops have been removed:
...
(in response to W1  Reviewer 6tyM)
SANA [1]
